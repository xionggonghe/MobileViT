...
for file in os.listdir(norm_dir):
    ...
    if (
        ...
        module = importlib.import_module("ViTlayers.normalization." + model_name)
...
from ViTlayers.normalization.batch_norm import BatchNorm2d, BatchNorm1d, BatchNorm3d
from ViTlayers.normalization.group_norm import GroupNorm
from ViTlayers.normalization.instance_norm import InstanceNorm1d, InstanceNorm2d
from ViTlayers.normalization.sync_batch_norm import SyncBatchNorm
from ViTlayers.normalization.layer_norm import LayerNorm, LayerNorm2D
